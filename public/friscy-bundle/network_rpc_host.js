...
//
// Bridges the worker's synchronous network calls to async networking paths.
// Tier 3 slice: optional dedicated net lane worker with bounded queue
// and deterministic fallback to direct bridge calls.
