/* @ts-self-types="./rv2wasm_jit.d.ts" */
 ...
 * @returns {Uint8Array}
 */
export function compile_region(code, base_addr) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rv2wasm_jit_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
