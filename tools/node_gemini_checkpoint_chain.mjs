...
async function runCommand(page, cmd, timeoutMs = 1200000) {
  ...
  try {
    await page.click('#terminal', { delay: 0 });
  } catch {}
...
async function main() {
  ...
  try {
    ...
    const haikuCmd = offlineOnly ? '__GEMINI_HELP__' : '__GEMINI_HAIKU__';
    ...
    const limCmd = offlineOnly ? '__GEMINI_HELP__' : '__GEMINI_LIMERICK__';
